...
const mcp = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$modelcontextprotocol$2f$sdk$2f$dist$2f$esm$2f$client$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Client"]({
...
async function initMCP(serverScriptPath) {
    if (connected) return;
    const command = serverScriptPath.endsWith(".ts") ? "npx" : ("TURBOPACK compile-time truthy", 1) ? "node" : ("TURBOPACK unreachable", undefined);
...
;
;
const SERVER_PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), "../chat-mcp-server/custom-fs-mcp-server/build/index.js");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1177e7f2._.js.map